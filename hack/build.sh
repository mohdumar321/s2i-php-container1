...
function squash {
  ...
  #        compatibility issues
   ...
   easy_install -q --user https://github.com/goldmann/docker-squash/archive/master.zip
   easy_install -q --user https://github.com/docker/docker-py/archive/master.zip
